    ...
    return (
        <div className="bg-black text-white py-20" id="project">
            <div className="container mx-auto px-8 md:px-16 lg:px-24">
                <h2 className="text-4xl font-bold text-center mb-12">{projects.name}</h2>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                    {projects.section.map(project => (
                        <div key={projects.id} className='bg-gray-800 p-6 rounded-lg transition-transform duration-300 transform hover:shadow-lg hover:scale-105'>
                            <img src={project.image} alt={projects.name} className='w-full h-40 object-cover rounded-md' />
